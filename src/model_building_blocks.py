...
class PairwiseScore(nn.Module):
    ...
    """
    def __init__(self, gij_dim, distance_dim, genre_dim, speaker_dim, K):
        super().__init__()
    ...
    def forward(self, spans, g_i, mention_scores):
        ...
        spans = [
            attr.evolve(span, yi=spans[max(0, idx-self.K):idx])
